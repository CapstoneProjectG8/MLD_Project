...
namespace Project_MLD.Controllers
{
    ...
    public class Document1CuriculumDistributionController : ControllerBase
    {
        ...
        [HttpDelete("DeleteDocument1CurriculumDistributionByDocument1ID")]
        public async Task<IActionResult> DeleteDocument1CurriculumDistributionByDocument1ID(int id)
        {
            try
            {
                await _repository.DeleteDocument1CurriculumDistributionByDoc1ID(id);
