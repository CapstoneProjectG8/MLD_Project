...
//    private readonly Mock<IDocument1PeriodicAssessmentRepository> _mockPeriodicAssessmentDoc1Repository;
...
//        _mockPeriodicAssessmentDoc1Repository = new Mock<IDocument1PeriodicAssessmentRepository>();
...
//        // Act
//        var result = await _controller.GetAllDocument1();
//        // Assert
...
//            // Act
//            var result = await _controller.GetDocument1ByApprovalID(id);
