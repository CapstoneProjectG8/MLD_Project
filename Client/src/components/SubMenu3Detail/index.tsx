          ...
          >
            ...
            <div className="sub-menu-content-main">
                                    ...
                                    <div className="add-row-button">
                                      ...
                                      {row.equipment.length > 1 && (
                                        <Remove
                                          ...
                                          className="add-row-icon"
                                          onClick={() =>
                                            handleRemoveEquip(index, equipIndex)
                                          }
                                        />
                                      )}
                                    </div>
              ...
              <div className="sub-menu-content-main-feature">
                <div className="sub-menu-content-main-feature-item">
                  <div>
                    <strong>2. Chuyên đề lựa chọn</strong>(đối với cấp trung học
                    phổ thông)
                  </div>
                </div>
                <div className="sub-menu-content-main-feature-table">
              ...
              <div className="sub-menu-content-main-feature">
                <div className="sub-menu-content-main-feature-item">
                  <strong>II. Nhiệm vụ khác (nếu có)</strong>(Bồi dưỡng học sinh
                  giỏi; Tổ chức hoạt động giáo dục)
                </div>
          ...
          <div className="sub-menu-infomation">
            ...
            <div className="sub-menu-row">
              <div>
                ...
                <u className="underline-blue">{document3Info?.userFullName}</u>
              </div>
            </div>
            <div className="sub-menu-row">
              <div>
